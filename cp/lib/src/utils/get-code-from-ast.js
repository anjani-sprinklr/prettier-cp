...
var getCodeFromAst = function (
  ...
  var nodesToRemoveFromCode = __spreadArray(
    __spreadArray(
      __spreadArray(
        __spreadArray(
          [],
  ...
  var codeWithoutImportsAndInterpreter = (0, remove_nodes_from_original_code_1.removeNodesFromOriginalCode)(
    originalCode,
  ...
  //console.log("START*******\n\n",code.replace(/"PRETTIER_PLUGIN_SORT_IMPORTS_NEW_LINE";/gi, constants_1.newLineCharacters),"*******************\n\nend");
  var finalCode =
    code.replace(/"PRETTIER_PLUGIN_SORT_IMPORTS_NEW_LINE";/gi, constants_1.newLineCharacters) +
